export class CountMap<T extends Object>
{
     ...
     * If `CountMap` does not have `key`, creates new counter value and initializes it to the value of `steps`.
     ...
     */
    increment(key: T, steps: number = 1): CountMap<T>
    {
     ...
     */
    decrement(key: T, steps: number = 1): CountMap<T>
    {
        const count = this.map.get(key);
